...
const FooterDark = () => {
  ...
  return (
    <footer className=" bg-[#0f0f0f] border-t border-zinc-800">
      <div className="max-w-7xl  mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <ul className="space-y-2 ">
                  {links.map((link) => (
                    <li key={link}>
                      <a
                        href="#"
                        className="text-gray-400 hover:text-white text-md transition-colors"
                      >
                        {link}
                      </a>
                    </li>
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-md text-gray-400">
          <div className="flex flex-wrap items-center gap-4">
            <span className="text-white">© 2026 Coinbase</span>
